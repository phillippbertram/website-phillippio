        ...
        <div class="row">
          ...
          <div class="col-lg-8 col-12 section-space--bottom--30 pl-30 pl-sm-15 pl-xs-15">
            <div class="project-details">
              <h2 class="title">
                {{ data.projectDetails.projectDetailsTitle }}
              </h2>
              <p v-html="data.projectDetails.projectDetailsDesc">
                {{ data.projectDetails.projectDetailsDesc }}
              </p>
              <div class="screenshot-gallery">
                ...
                <client-only>
                  <swiper :options="swiperOption">
                    <div v-for="image in data.projectDetails.images" :key="image.id" class="swiper-slide">
